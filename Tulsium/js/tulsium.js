function arizonaInfo(){
    ...
    document.getElementById('infoText').innerHTML = "<p>We currently do not have anyone in this area. However, we are planning to expand to here! Nevertheless, let us know as we maybe able to send someone out there</p>";
}
function caliInfo(){
